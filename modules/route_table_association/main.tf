...
resource "aws_route_table_association" "route_table_association" {
  ...
  subnet_id      = var.route_table_association[count.index].subnet_name != null ? data.aws_subnet.data_subnet_id[var.route_table_association[count.index].subnet_name].id : null  
  route_table_id = var.route_table_association[count.index].route_table_name != null ? data.aws_route_table.route_table_id[var.route_table_association[count.index].route_table_name].id : null
